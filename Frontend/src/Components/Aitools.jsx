...
function Aitools() {
    ...
    return (
        <div>
            ...
            <h2 className='text-[42px] text-transparent font-extrabold bg-clip-text 
            bg-gradient-to-r from-purple-500 to-indigo-600 drop-shadow-lg leading-tight'>Powerful AI Tools </h2>
